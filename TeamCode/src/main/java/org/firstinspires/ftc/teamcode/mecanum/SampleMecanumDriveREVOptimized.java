...
public class SampleMecanumDriveREVOptimized extends SampleMecanumDriveBase {
    ...
    public SampleMecanumDriveREVOptimized(HardwareMap hardwareMap) {
        ...
        leftFront = hardwareMap.get(ExpansionHubMotor.class, "FLMotor");
        leftRear = hardwareMap.get(ExpansionHubMotor.class, "BLMotor");
        rightRear = hardwareMap.get(ExpansionHubMotor.class, "BRMotor");
        rightFront = hardwareMap.get(ExpansionHubMotor.class, "FRMotor");
